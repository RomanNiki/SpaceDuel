...
namespace _Project.Develop.Runtime.Engine.UI.Factories
{
    public class UIFactory : IUIFactory
    {
        ...
        {
            _gameplayHudAssetLoader.UnloadAndDestroy();
        }

        public void CloseControlsWindow()
        {
            _controlsController?.Dispose();
            _controlsWindowAssetLoader.UnloadAndDestroy();
        }

        public void ClosePauseMenu()
        {
            _pauseMenuController?.Dispose();
            _pauseMenuAssetLoader.UnloadAndDestroy();
        }
    }
}